...
{
	string Code1[2] = { "Встретился неопознаный символ, повторите попытку", "Странный символ, ожидалось число (например: 56780 или 54387.098)" };
	string Code2[2] = { "Число не соответсвует требованиям программы", "Число не входит в дозволенный диапозон(от −9.223.372.036.854.775.808 до +9.223.372.036.854.775.807)" };
	if (errorCode == 1)
	{
