...
{
	string Code1[2] = { "Ââåäèòå ÷òî-íèáóäü, èçâèíèòå", "Öåëàÿ ÷àòü âòîðîãî ÷èñëà ââåäåíà íåïðàâèëüíî, èçâèíèòå" };
	string Code2[2] = { "Îøèáêà â äðîáíîé ÷àñòè âòîðîãî ÷èñëà, èçâèíèòå", "Âòîðîå ÷èñëî ñëèøêîì áîëüøîå, èçâèíèòå" };
	if (errorCode == 1)
	{
